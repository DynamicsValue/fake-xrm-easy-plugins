...
namespace FakeXrmEasy.Pipeline
{
    ...
    internal static class PipelineProcessor
    {
        ...
        {
            var plugins = RegisteredPluginStepsRetriever.GetPluginStepsForOrganizationRequest(context, parameters.Stage, parameters.Mode, parameters.Request);
            if (plugins == null)
                return;
        ...
        internal static void PopulatePrePluginStageParameters(IXrmFakedContext context,
            OrganizationRequest request)
        {
