...
Write-Host "Packing All Configurations for project $($projectName)" -ForegroundColor Green
 ...
 if($targetFrameworks -eq "netcoreapp3.1")
 {
    ...
    ./pack-configuration.ps1 -targetFrameworks $targetFrameworks -projectName $projectName -projectPath $projectPath -packageIdPrefix $packageIdPrefix -versionSuffix $versionSuffix -packTests $packTests -configuration "FAKE_XRM_EASY" 
